; DEBUG: DAG con 28 libros:
; prerequisitos on
; paralelos off
; npaginas off
; Fichero generado con el programa, seed 1234
(define (problem Libros-base)
	(:domain Lectura)
	(:objects
		Enero Febrero Marzo Abril Mayo Junio Julio Agosto Septiembre Octubre Noviembre Diciembre - mes
		Libro0 Libro1 Libro2 Libro3 Libro4 Libro5 Libro6 Libro7 Libro8 Libro9 Libro10 Libro11 Libro12 Libro13 Libro14 Libro15 Libro16 Libro17 Libro18 Libro19 Libro20 Libro21 Libro22 Libro23 Libro24 Libro25 Libro26 Libro27 - libro
	)
	...
	(:init
		...
		(quiere_leer Libro25)
		(quiere_leer Libro27)
		(predecesor Libro0 Libro22)
		(predecesor Libro1 Libro9)
		(predecesor Libro2 Libro15)
		(predecesor Libro3 Libro5)
		(predecesor Libro4 Libro10)
		(predecesor Libro5 Libro6)
		(predecesor Libro6 Libro7)
		(predecesor Libro7 Libro27)
		(predecesor Libro8 Libro24)
		(predecesor Libro13 Libro14)
		(predecesor Libro16 Libro18)
		(predecesor Libro17 Libro26)
		(predecesor Libro18 Libro21)
	)
